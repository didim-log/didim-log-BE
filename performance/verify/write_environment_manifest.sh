...
export ADMIN_SECRET_KEY SWAGGER_USERNAME SWAGGER_PASSWORD AI_ENABLED GEMINI_API_KEY GEMINI_API_URL
...
export PERF_BOJ_ID PERF_STUDENT_ID PERF_NICKNAME PERF_AI_BOJ_ID_PREFIX PERF_PASSWORD PERF_BCRYPT_PASSWORD JWT_TTL_SECONDS
...
manifest = {
    ...
    "fixture": {
        ...
        "studentId": value("PERF_STUDENT_ID"),
