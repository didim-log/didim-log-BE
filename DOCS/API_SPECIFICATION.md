...
[
  {
    "title": "🔑 핵심 로직",
    "guide": "이 문제의 가장 중요한 점화식이나 아이디어는 무엇인가요?",
    "category": "SUCCESS"
  },
  {
    "title": "⏱️ 복잡도 분석",
  ...
  {
    "title": "🧐 실패 원인",
    "guide": "문제를 풀지 못한 주요 원인은 무엇인가요? (엣지 케이스, 로직 오류 등)",
    "category": "FAIL"
  },
  {
    "title": "📚 부족했던 개념",
    "guide": "부족했던 알고리즘 개념이나 자료구조를 적어보세요.",
    "category": "FAIL"
  },
  {
    "title": "🐛 디버깅 과정",
