...
실행기를 얻지 못한 `PENDING` 작업과 lease가 만료된 `RUNNING` 작업을 같은 job에서 이어서 처리하는 기준은 [문제 수집 만료 작업 자동 인계](./DOCS/refactoring/be-refactor/PHASE_6M_B_CRAWLER_WORKER_TAKEOVER.md)에 정리했습니다.
